...
type StoreData = { user: { name: string; role: string }; products: StoreProduct[]; movements: StoreMovement[]; expiring: ExpiringBatch[] };
...
export default function StoreView() {
  ...
  return <section className="store-page">
    ...
    <div className="store-metrics">
      ...
      <article><span>Unidades en recepción</span><strong>{receptionUnits}</strong><small>Disponibles para el futuro POS</small></article>
